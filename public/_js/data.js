...
var textMil = {
	...
	start			: "<h3> Your <span>",
	plantS		:	"</span> are ready to Plant!</h3><img src='http://localhost/public/_images/plant_images/",
	...
	sproutS 	: "</span> will be Sprouting soon!</h3><img src='http://localhost/public/_images/plant_images/",
	...
	thinS 		: "</span> need to be Thinned soon!</h3><img src='http://localhost/public/_images/plant_images/",
	...
	fertS 		: "</span> will need Fertilizing soon!</h3><img src='http://localhost/public/_images/plant_images/",
	...
	harvestS 	: "</span> will be ready to Harvest soon!</h3><img src='http://localhost/public/_images/plant_images/",
	harvestF	:	"_harvest.jpg'/><p>Your hard work is finally bearing fruit (or vegetables).  After you’ve checked the harvesting information in your plant’s description, get to work getting those delicious treasures picked and stored!</p><p>If you’ve read the harvesting information and it seems too early, that’s fine!  As always, all plants are different, and grow at differing times.  Just make sure to check for the appropriate harvesting conditions so you can get as much as possible in your yield.",
